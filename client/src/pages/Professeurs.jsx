                ...
                <div className='w-full my-auto h-6/7 text-center p-3'>
                    <div className="flex flex-col h-full">
                        ...
                        <div className="mt-2 py-3 shadow">
                            <form action="">
                                <label className="text-gray-800 me-4" htmlFor="classId">Identifiant du professeurs :</label>
                                <input 
                                    ...
                                    name="ProfId" 
                                    type="text" />
                                <label className="text-gray-800 me-4" htmlFor="RoomLabel">Nom et prénoms :</label>
                                <input 
                                    className="me-4 w-100 px-3 py-1 text-gray-800 outline-0 border
                                     border-gray-400 shadow rounded
                                     focus:shadow focus:shadow-emerald-600" 
                                    name="ProfName" 
                                    type="text" />
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 w-100">
            ...
            <form action="">
                ...
                <input 
                    ...
                    name="ProfId" 
                    type="text" />
                <label className="block text-gray-800 me-4 mb-3" htmlFor="RoomLabel">Nom et prénoms :</label>
                <input 
                    className="me-4 mb-4 w-full px-3 py-1 text-gray-800 outline-0 border
                     border-gray-400  shadow rounded
                     focus:shadow focus:shadow-emerald-600" 
